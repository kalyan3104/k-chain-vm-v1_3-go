...
func TestScenariosCheckDCDTErr1(t *testing.T) {
	err := runSingleTestReturnError("scenarios-self-test/set-check", "set-check-dcdt.err1.json")
	require.EqualError(t, err,
...
func TestScenariosDcdtZeroBalance(t *testing.T) {
	err := runSingleTestReturnError("scenarios-self-test", "dcdt-zero-balance-check-err.scen.json")
	require.EqualError(t, err,
...
func TestScenariosDcdtNonZeroBalance(t *testing.T) {
	err := runSingleTestReturnError("scenarios-self-test", "dcdt-non-zero-balance-check-err.scen.json")
	require.EqualError(t, err,
